    ...
    <div className="font-sans max-w-5xl mx-auto">
      ...
      {allTags.length > 0 && (
        <div className="mb-4 sm:mb-6 md:mb-8">
          ...
          <nav aria-label="タグフィルター" role="tablist">
            <div className="flex flex-wrap gap-2 mb-2">
              <Link
                to="/"
                className={`px-3 py-1 rounded-full text-sm border focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 transition-all ${
                  !selectedTag
      ...
      {/* ギャラリー表示：セマンティックHTMLとアクセシビリティ強化 */}
      <section
        aria-label={
          selectedTag ? `タグ「${selectedTag}」の手ぬぐい一覧` : "手ぬぐい一覧"
        }
        role="region"
      >
        <div
          ...
          role="grid"
          aria-label={`${filteredCount}件の手ぬぐい`}
        >
